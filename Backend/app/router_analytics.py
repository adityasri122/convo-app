...
from sqlalchemy import Column, Integer, String, Boolean, Numeric, DateTime, Text, text
from sqlalchemy.dialects.postgresql import UUID as PGUUID
from sqlalchemy.ext.asyncio import AsyncSession
from fastapi import Request

from .models import Base, RouterAnalytics
...
async def get_usage_stats(session: AsyncSession, days: int = 30) -> dict:
    ...
    try:
        ...
        query = text("""
                     SELECT COUNT(DISTINCT CASE WHEN event_type = 'search' THEN session_id END) AS total_searches,
                     ...
                     COUNT(DISTINCT shop_id) AS unique_shops_discoveredFROM router_analytics
