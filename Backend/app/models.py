...
class RouterAnalytics(Base):
    ...
    # Search
    search_latitude: Mapped[float | None] = mapped_column(
        Numeric(10, 7),
        nullable=True,
    )

    search_longitude: Mapped[float | None] = mapped_column(
        Numeric(10, 7),
        nullable=True,
    )

    search_radius_miles: Mapped[float | None] = mapped_column(
        Numeric(6, 2),
        nullable=True,
    )

    search_category: Mapped[str | None] = mapped_column(
        String(100),
        nullable=True,
    )

    search_results_count: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
    )
    ...
    delegation_intent: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    )

    customer_to_shop_miles: Mapped[float | None] = mapped_column(
        Numeric(8, 2),
        nullable=True,
    )
